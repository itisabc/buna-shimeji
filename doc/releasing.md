...
```powershell
$ver   = "0.1.2"   # Cargo.toml の version に合わせる
...
2. **Tag**: `v0.1.2`（`Cargo.toml` の `version` と一致させる）
3. **Title**: `v0.1.2`
...
下の `buna-shimeji-v0.1.2-win64.zip` をダウンロードして展開してください。
